...
/**
 * Send commit notification for Parts CLI submodule
...
function getCommitData(): CommitData {
  return {
    ...
    service_name: process.env.SERVICE_NAME || 'Parts CLI',
...
async function sendNotification() {
  try {
    ...
    console.error(`❌ Error sending ${process.env.SERVICE_NAME || 'Parts CLI'} notification!`);
